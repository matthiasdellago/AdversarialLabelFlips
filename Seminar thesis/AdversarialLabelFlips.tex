...
\begin{abstract}
	...
	Given a neural network (NN) trained to classify and a untargeted evasion attack, in what class does the adversarial example fall?
...
In our experiments (Section \ref{sec:experiments}) we used the foolbox framework \cite{}, and simple NNs trained on the MNIST \cite{}, FashionMNIST \cite{}, and CIFAR-10 \cite{} datasets. We applied three state of the art attacks: Projected Gradient Decent (PDG)\cite{}, Carlini-Wagner \cite{} and Brendel-Bethge\cite{}. 
...
Since being first demonstrated \cite{Szegedy13} a large body of literature has flourished around adversarial examples. \textbf{Blablabla... short literature review}
...
This is joint work from Maximilian Samsinger and Matthias Dellago. Max wrote the code... % Du kannst ruhig "main contributor" schreiben, wenn dir das lieber ist :)
%Na, kein stress, passt gut 
